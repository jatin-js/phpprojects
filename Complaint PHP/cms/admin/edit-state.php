...
if(isset($_POST['submit']))
{
	...
	$id=intval($_GET['id']);
$sql=mysql_query("update state set stateName='$state',stateDescription='$description',updationDate='$currentTime' where id='$id'");
...
<?php
$id=intval($_GET['id']);
$query=mysql_query("select * from state where id='$id'");
