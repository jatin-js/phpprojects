...
$query=mysql_query("SELECT * FROM users WHERE userEmail='$email' and contactNo='$contact'");
$num=mysql_fetch_array($query);
if($num>0)
{
mysql_query("update users set password='$password' WHERE userEmail='$email' and contactNo='$contact' ");
